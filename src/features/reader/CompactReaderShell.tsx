  ...
  return (
    <article className="reader-shell" data-testid="reader-shell">
      ...
      {controlsOpen && visibleControls.length > 0 ? (
        <section className="reader-settings-panel" data-testid="reader-control-panel-group" id="reader-controls-panel">
      ...
      {actionAside ? <div className="reader-shell__footer-actions">{actionAside}</div> : null}
    </article>
  );
}
